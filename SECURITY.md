...
If you discover a security vulnerability, please report it by using the GitHub [security advisories](https://github.com/innotegrity/go-mod-xtypes/security/advisories) feature.
